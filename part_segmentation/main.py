...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='./SAST_setting_7_eigh/', help='log path')          
    # parser.add_argument('--decay_rate', type=float, default=1e-4, help='weight decay')
    parser.add_argument('--npoint', type=int, default=2048, help='point Number')
    parser.add_argument('--normal', action='store_true', default=False, help='use normals')    
    parser.add_argument('--config', type=str, default="/export/livia/home/vision/Abahri/projects/SST_Mamba/SST_Mamba/part_segmentation/cfgs/config.yaml", help='config file')
    # parser.add_argument('--step_size', type=int, default=20, help='decay step for lr decay')
    # parser.add_argument('--lr_decay', type=float, default=0.5, help='decay rate for lr decay')
    parser.add_argument('--ckpts', type=str, default="/export/gauss/vision/Abahri/projects/Point-MAMBA-New/PointMamba/experiments_15_April/pretrain/cfgs/metod_k_top_eigenvectors_seperate_learnable_tokens__reverse_True__knn_graph_20__k_small_eigenvectors_4__lr_1e3_Pretrain/ckpt-best.pth", help='ckpts')
    # parser.add_argument('--ckpts', type=str, default="/export/gauss/vision/Abahri/projects/Point-MAMBA-Github/Point-MAMBA/experiments_18_May/pretrain/cfgs/1_metod_k_top_eigenvectors_seperate_learnable_tokens__reverse_True__knn_graph_20__k_small_eigenvectors_4__lr_1e3_Pretrain/ckpt-best.pth", help='ckpts')
    parser.add_argument('--root', type=str, default='/export/gauss/vision/Abahri/projects/Point-MAE/ORIGINAL/Point-MAE/data/shapenetcore_partanno_segmentation_benchmark_v0_normal/',
                        help='data root')
