...
| :---- | :---- | :---- |:-------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Pre-training | ShapeNet | [pretrain.yaml](./cfgs/pretrain.yaml) | 91.05   | [ckpt](https://github.com/LMD0311/PointMamba/releases/download/ckpts-2/pretrain.pth)  [log](https://github.com/AliBahri94/SI-Mamba/blob/main/logs/pretrain_part_2.log)  |
